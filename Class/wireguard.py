...
class Wireguard(Base):
    ...
    def updateConfig(self):
        ...
        if not "subnetLinkLocal" in self.config: self.config['subnetLinkLocal'] = "fe82::/16"
    ...
    def init(self,id,listen):
        ...
        "subnetVXLAN":"10.0.251.0/24","subnetLinkLocal":"fe82::/16","AllowedPeers":[],"prefix":"pipe","id":int(id),"linkTypes":["default"],"defaultLinkType":"default","connectivity":connectivity,
