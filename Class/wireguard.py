...
class Wireguard(Base):
    ...
    def updateConfig(self):
        ...
        if not "optimize" in self.config: self.config['optimize'] = True
    ...
    def init(self,id,listen):
        ...
        config = {"listen":listen,"listenPort":8080,"basePort":51820,"optimize":True,"vxlanOffset":0,"subnet":"10.0.0.0/16","subnetPeer":"172.31.0.0/16",
