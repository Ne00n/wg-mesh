...
apt-get install wireguard iptables bird2 sudo python3 python3-netaddr python3-paste python3-bottle python3-requests python3-pip fping mtr-tiny vnstat git -y
cd /opt/
#git
...
#systemctl enable wgmesh-rotate && systemctl start wgmesh