...
options = "init <id>, status, used, bender, migrate, recover, connect/peer <http://IP/DOMAIN:8080> <token>, tunnel, disconnect, up, down, clean, proximity, token, disable, enable, set, cost"
#path
